...
const LetsTalks = () => {
  return (
    <>
      <div className="flex max-md:flex-col gap-9 sm:gap-14 2xl:gap-[110px] justify-center mx-auto pt-12 sm:pt-16 md:pt-[100px] lg:pt-[160px] xl:pt-[200px] 2xl:pt-[241px] lg:mb-[127px]  px-4 sm:px-7  xl:px-[55px]">
